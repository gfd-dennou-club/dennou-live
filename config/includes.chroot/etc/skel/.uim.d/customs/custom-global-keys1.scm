(define generic-on-key '("zenkaku-hankaku" "<Super> "))
(define generic-on-key? (make-key-predicate '("zenkaku-hankaku" "<Super> ")))
(define generic-off-key '("zenkaku-hankaku" "<Super> "))
(define generic-off-key? (make-key-predicate '("zenkaku-hankaku" "<Super> ")))
